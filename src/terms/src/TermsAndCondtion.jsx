    ...
    return (
        <div className="policy-container">
            ...
            <ul>
                ...
                <li>You may not create a link to our website from another website or document without REKHA DEVI’s prior written consent.</li>
            ...
            <p className="disclaimer">
                Disclaimer: The above content is created at REKHA DEVI's sole discretion. Razorpay shall not be liable for any content provided here and shall not be responsible for any claims and liability that may arise due to the merchant’s non-adherence to it.
            </p>
        </div>
    )
}
